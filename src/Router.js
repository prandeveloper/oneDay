...
import JournalDetails from "./views/apps/journal/JournalDetails";
import Journal from "./views/apps/journal/Journal";
import JournalList from "./views/apps/journal/JournalList";
    ...
    return (
      ...
      <Router history={history}>
        <Switch>
          ...
          <AppRoute path="/app/journal/journal" component={Journal} />
          <AppRoute
            path="/app/journal/journalDetails"
            component={JournalDetails}
          />
          <AppRoute
            path="/app/journal/journalList"
            component={JournalList}
          />


          {/* <AppRoute path="/journal/jorunal" component={journal} /> */}
          {/* JOURNAL End */}
