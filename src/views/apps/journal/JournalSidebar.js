...
// import { changeFilter } from "../../../redux/actions/journal/index"
import { connect } from "react-redux"
import "react-draft-wysiwyg/dist/react-draft-wysiwyg.css"
import "../../../assets/scss/plugins/extensions/editor.scss"
class JournalSidebar extends React.Component {
    state = {
        modal: false
    }
                    ...
                    >
                        <ListGroup className="list-group-messages font-medium-1">
                            <ListGroupItem
                                ...
                                active={"/journal/inbox" === this.props.routerProps.location.pathname}
                            ...
                            <ListGroupItem
                                ...
                                active={"/journal/sent" === this.props.routerProps.location.pathname}
                            ...
                            <ListGroupItem
                                ...
                                active={"/journal/draft" === this.props.routerProps.location.pathname}
                                className="border-0 cursor-pointer"
                            >
                                <Edit2 size={21} />
                            ...
                            <ListGroupItem
                                ...
                                active={"/journal/starred" === this.props.routerProps.location.pathname}
                                className="border-0 cursor-pointer"
                            >
                                <Star size={21} />
                            ...
                            <ListGroupItem
                                ...
                                active={"/journal/spam" === this.props.routerProps.location.pathname}
                                className="border-0 cursor-pointer"
                            >
                                <Info size={21} />
                            ...
                            <ListGroupItem
                                ...
                                active={"/journal/trash" === this.props.routerProps.location.pathname}
                                className="border-0 cursor-pointer"
                            >
                                <Trash size={21} />
                        ...
                        <ListGroup className="list-group-labels font-medium-1">
                            <ListGroupItem
                                ...
                                active={"/journal/personal" === this.props.routerProps.location.pathname}
                            >
                            ...
                            <ListGroupItem
                                ...
                                active={"/journal/company" === this.props.routerProps.location.pathname}
                            >
                            ...
                            <ListGroupItem
                                ...
                                active={"/journal/important" === this.props.routerProps.location.pathname}
                            >
                            ...
                            <ListGroupItem
                                ...
                                active={"/journal/private" === this.props.routerProps.location.pathname}
                            >
