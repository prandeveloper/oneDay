            ...
            >
                            ...
                            <li className="list-inline-item mr-1">
                                <UncontrolledDropdown className="folder-droppdown">
                                    ...
                                    <DropdownMenu tag="ul" right>
                                        <DropdownItem
                                            tag="li"
                                            className={`${"inbox" === this.props.currentParam.filter
                                                ? "d-none"
                                                : ""
                                                }`}
                                            onClick={() => {
                                        ...
                                        <DropdownItem
                                            tag="li"
                                            className={`${"draft" === this.props.currentParam.filter
                                                ? "d-none"
                                                : ""
                                                }`}
                                            onClick={() => {
                                        ...
                                        <DropdownItem
                                            tag="li"
                                            className={`${"spam" === this.props.currentParam.filter
                                                ? "d-none"
                                                : ""
                                                }`}
                                            onClick={() => {
                                        ...
                                        <DropdownItem
                                            tag="li"
                                            className={`${"trash" === this.props.currentParam.filter
                                                ? "d-none"
                                                : ""
                                                }`}
                                            onClick={() => {
                ...
                >
                    <Row>
                        <Col sm="12">
                            <div className="email-label ml-2 my-2 pl-1">
                                {Array.isArray(currentMail.labels) ? (
                                    currentMail.labels.map(item => {
                                        return (
                                            <React.Fragment key={item}>
                                                <span
                                                    className={`mr-50 bullet bullet-${item === "important"
                                                        ? "warning"
                                                        : item === "personal"
                                                            ? "success"
                                                            : item === "private"
                                    ...
                                    <React.Fragment>
                                        <span
                                            className={`mr-50 bullet bullet-${currentMail.labels === "important"
                                                ? "warning"
                        ...
                        <Col
                            sm="12"
                            className={`mb-1 ${currentMail.replies && currentMail.replies.length < 1
                                ? "d-none"
                                : ""
                                }`}
                        >
                ...
                `}
                            ...
                            <div
                                className={`earlier-replies ${this.state.showReplies === false ? "d-none" : "d-block"
                                    }`}
                            >
